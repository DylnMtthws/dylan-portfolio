...
export default function DotGroup({ selectedPage, setSelectedPage }) {
  ...
  return (
    <div className="flex flex-col gap-6 fixed top-[60%] right-7">
      <AnchorLink
        className={`${
          selectedPage === "home" ? selectedStyles : "bg-gray"
      ...
      <AnchorLink
        className={`${
          selectedPage === "skills" ? selectedStyles : "bg-gray"
        } w-3 h-3 rounded-full`}
        href={`#skills`}
      ...
      <AnchorLink
        className={`${
          selectedPage === "projects" ? selectedStyles : "bg-gray"
        } w-3 h-3 rounded-full`}
        href={`#projects`}
      ...
      <AnchorLink
        className={`${
          selectedPage === "contact" ? selectedStyles : "bg-gray"
        } w-3 h-3 rounded-full`}
        href={`#contact`}
